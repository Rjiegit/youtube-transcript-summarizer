...
from whisper_summary.domain.interfaces.database import BaseDB, ProcessingLockInfo
from whisper_summary.domain.tasks.models import Task
from whisper_summary.infrastructure.persistence.sqlite.schema import initialize_schema
from whisper_summary.infrastructure.persistence.sqlite.task_adapter import SQLiteTaskAdapter
...
class SQLiteDB(BaseDB):
    ...
    def _create_table(self) -> None:
        """Create application tables and ensure required columns."""
