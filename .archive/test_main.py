...
class TestMain(unittest.TestCase):
    ...
    def test_init_without_dependencies(self, mock_processor_class, mock_summary_storage_class, 
                                      mock_file_manager_class, mock_summarizer_class, 
                                      mock_transcriber_class, mock_config_class):
    ...
    def test_run(self):
        ...
        self.mock_file_manager.get_files_to_process.assert_called_once_with(self.mock_config.file_patterns)
