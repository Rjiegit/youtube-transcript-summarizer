...
class TestTranscriber(unittest.TestCase):
    ...
    def test_transcribe_with_whisper(self, mock_whisper):
        ...
        mock_whisper.load_model.assert_called_once_with(self.mock_config.transcription_model_size)
        
        # Verify that the transcribe method was called with the correct parameters
        mock_model.transcribe.assert_called_once_with(self.test_file_path, verbose=True, fp16=False)
    ...
    def test_init_with_config(self):
        ...
        self.assertEqual(transcriber.model_size, self.mock_config.transcription_model_size)
